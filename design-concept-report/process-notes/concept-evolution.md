...
## Final concept
The final concept focuses on Notion AR for Meta Quest 3. The user selects and places a Notion note, draws a simple 2D shape/design, lifts it into a 3D representation using a two-hand gesture, and moves it with pinch interaction.

## Scope decision
The current concept focuses on simple shapes, basic drawings, and core spatial movement. More complex editing or accurate architectural modelling is left as future development.
